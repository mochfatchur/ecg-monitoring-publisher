...
def demo_aead(variant):
    ...
    key = bytes([0x90, 0x80, 0x70, 0x60, 0x50, 0x40, 0x30, 0x20, 0x10, 0xAA, 0x90, 0x90, 0x90, 0x90, 0xCC, 0xEF])
    nonce = bytes([0xc9, 0x15, 0x40, 0x6d, 0x5a, 0x54, 0xc0, 0x49, 0x8a, 0x31, 0x53, 0x58, 0xb0, 0x0e, 0x53, 0xd2])
    ...
    print("test plaintext: ", plaintext.decode('utf-8'))
